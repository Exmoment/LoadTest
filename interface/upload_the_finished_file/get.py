...
class Widget_GET_Requests:
    ...
    def GET(self):
        ...
        back_btn = Button(master = get_req, text = 'Вернуться к выбору запросов', command = lambda:[get_req.destroy(), controller_widgets.widget_dontgenerate(), controller_widgets.window_yes.config(load_file_menu.destroy())])
